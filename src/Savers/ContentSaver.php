...
class ContentSaver
{
    ...
    public function saveContent($data)
    {
        ...
        $filePath = $this->contentDir . '/' . 'posts/' . $data['category'] . '/' . $data['slug'] . '.md';
    ...
    private function generateFrontmatter($data)
    {
        ...
        $frontmatter .= "template: " . (isset($data['template']) ? "\"" . addslashes($data['template']) . "\"" : 'post') . "\n";
        $frontmatter .= "author: \"" . addslashes($data['author']) . "\"\n";
        $frontmatter .= "date: \"" . date('Y-m-d', strtotime($data['date'])) . "\"\n";
        $frontmatter .= "category: \"" . addslashes($data['category']) . "\"\n";
